...
pub static RONNEBY_MILJOTEKNIK_ELNAT_AB: GridOperator = GridOperator::builder()
    ...
    .feed_in_revenue_info_default("https://www.ronneby.se/sidowebbplatser/miljoteknik/elnat/priser-villkor-for-elnat/ersattning-natnytta-mikroproducent.html")
    .build())
    .price_lists(&[
        PriceList::builder()
            .variant("Tariff 2")
            ...
            .feed_in_revenue(FeedInRevenue::fixed_subunit(7.0))
